...
public class PolylineDecoder {
	...
	// Produce a polyline path from an encoded polyline string
	// Adapted from http://jeffreysambells.com/2010/05/27/decoding-polylines-from-google-maps-direction-api-with-java
	public static MVCArray<LatLng> decodePoly(String encoded) {
			
		MVCArray<LatLng> poly = MVCArray.createArray().cast();
